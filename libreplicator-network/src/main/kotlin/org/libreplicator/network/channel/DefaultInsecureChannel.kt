...
class DefaultInsecureChannel(private val localUrl: String, private val localPort: Int) : InsecureChannel {
    ...
    override fun subscribe(observer: Observer<String>): Subscription = synchronized(this) {
        if (hasSubscription) {
